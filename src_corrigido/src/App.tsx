...
function App() {
 ...
 const [paginaAtual, setPaginaAtual] = useState<
  "cadastro" | "relatorio" | "dashboard" | "aso"
>("relatorio");
  ...
  const vagasFiltradas = codigoFiltro
    ...
    <div className="app">
      ...
      <main className="principal">
        ...
        <div className="menu-paginas">
          ...
          <button
            className={paginaAtual === "relatorio" ? "ativo" : ""}
          ...
          <>
            ...
            <div className="area-trabalho">
              ...
              <TelaCadastro
                ...
                modo={modoTela}
                admissoesPendentes={admissoesPendentes}
        ...
        {paginaAtual === "dashboard" && <Dashboard vagas={vagas} />}

{paginaAtual === "aso" && (
  <div className="pagina-em-construcao">
    <h2>Controle de ASO</h2>
    <p>Área destinada ao acompanhamento de exames admissionais.</p>
  </div>
)}      </main>
    </div>
  );
